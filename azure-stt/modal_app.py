"""Modal deployment for Pipecat Twilio inbound voice bot with Azure STT.
...
image = (
    ...
    .pip_install(
        "pipecat-ai[websocket,groq,silero,azure,deepgram,rnnoise,runner,local-smart-turn-v3]>=0.0.99",
        "pipecatcloud>=0.2.18",
        "python-dotenv",
        "requests",
    )
...
app = modal.App("twilio-azure-stt-bot")
